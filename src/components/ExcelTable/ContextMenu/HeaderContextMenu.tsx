...
import { ArrowLeftIcon, ArrowRightIcon, EyeIcon, FilterIcon, ThrashIcon } from '../Icons';
...
export default React.forwardRef<Component<ContextMenuProps>, IProps>(function HeaderContextMenu(
  ...
  return createPortal(
    <ContextMenu id={id} hideOnLeave ref={contextRef}>
      {data.map(({ title: itemTitle, onClick, Icon, disabled }) => (
        <MenuItem key={itemTitle} onClick={onClick} className={styles.MenuItem} disabled={disabled}>
